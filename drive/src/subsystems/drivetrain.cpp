...
const int8_t leftMiddle = 2;
const int8_t leftBack = 3;

const int8_t rightFront = 4;
const int8_t rightMiddle = 5;
const int8_t rightBack = 6;
...
.withSensors(leftFrontMotor.getEncoder(), rightFrontMotor.getEncoder())
.buildOdometry();